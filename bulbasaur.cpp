/*********************************************************************
 ** Program Filename: Program 3 - bulbasaur.cpp
 ** Author: Blake Roberts (robeblak@oregonstate.edu)
 ** Date: 2021-08-01
 ** Description: Implementation for child Bulbasaur class
 ** Input: None.
 ** Output: Bulbasaur objects, and console output. 
 *********************************************************************/
...
Bulbasaur::Bulbasaur(
    ...
    : Pokemon(
        ...
        speed, 
        ascii) {
        //print_str("Bulbsaur Constructed\n");
    }
...
Bulbasaur::~Bulbasaur() {
    /* default constructor */
    //print_str("Bulbasaur Destructed\n");
}
